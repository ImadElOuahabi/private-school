        ...
        <div className="row page-titles mx-0">
          ...
          <div className="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol className="breadcrumb">
              <li className="breadcrumb-item"><a href="javascript:void(0)">Events</a></li>
              <li className="breadcrumb-item active"><a href="javascript:void(0)">Events Management</a></li>
            </ol>
          </div>
        </div>
              ...
              <div className="card-body">
                ...
                <div>
                  <div id="external-events" className="my-3">
                    ...
                    <div className="external-event" data-class="bg-success"><i className="fa fa-move"></i>My Event</div>
